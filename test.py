...
def switchToGame():
    ...
    def addSteelPlateMaker():
        steelPlateMakerPhoto = PhotoImage(file="steelplatemaker.png")
        steelPlateMakerImage = Label(root, borderwidth="0", image=steelPlateMakerPhoto)
        steelPlateMakerImage.image = steelPlateMakerPhoto
        steelPlateMakerImage.place(x=553, y=89)
        steelPlateMaker.place_forget()
    def addBfurnace1():
        def addCircuitMaker():
            def addAdvCircuitMaker():
                def addBFurnace2():
                    def addBFurnace3():
                        def addBFurnace4():
                            def addBFurnace5():
                                bFurnace5Photo = PhotoImage(file="blastfurnace5.png")
                                bFurnace5Image = Label(root, borderwidth="0", image=bFurnace5Photo)
                                bFurnace5Image.image = bFurnace5Photo
                                bFurnace5Image.place(x=415, y=97)
                                bFurnace5.place_forget()
                            bFurnace4Photo = PhotoImage(file="blastfurnace4.png")
                            bFurnace4Image = Label(root, borderwidth="0", image=bFurnace4Photo)
                            bFurnace4Image.image = bFurnace4Photo
                            bFurnace4Image.place(x=415, y=97)
                            bFurnace4.place_forget()
                            bFurnace5 = Button(root, text="Add Blast Furnace Level 5", bg='black', fg='white',command=addBFurnace5)
                            bFurnace5.place(x=560, y=300)
                        bFurnace3Photo = PhotoImage(file="blastfurnace3.png")
                        bFurnace3Image = Label(root, borderwidth="0", image=bFurnace3Photo)
                        bFurnace3Image.image = bFurnace3Photo
                        bFurnace3Image.place(x=415, y=97)
                        bFurnace3.place_forget()
                        bFurnace4 = Button(root, text="Add Blast Furnace Level 4", bg='black', fg='white',command=addBFurnace4)
                        bFurnace4.place(x=560, y=300)
                    bFurnace2Photo = PhotoImage(file="blastfurnace2.png")
                    bFurnace2Image = Label(root, borderwidth="0", image=bFurnace2Photo)
                    bFurnace2Image.image = bFurnace2Photo
                    bFurnace2Image.place(x=415, y=97)
                    bFurnace2.place_forget()
                    bFurnace3 = Button(root, text="Add Blast Furnace Level 3", bg='black', fg='white',command=addBFurnace3)
                    bFurnace3.place(x=560, y=300)
                advCircuitPhoto = PhotoImage(file="advcircuitmaker.png")
                advCircuitMakerImage = Label(root, borderwidth="0", image=advCircuitPhoto)
                advCircuitMakerImage.image = advCircuitPhoto
                advCircuitMakerImage.place(x=552, y=125)
                advCircuitMaker.place_forget()
                bFurnace2 = Button(root, text="Add Blast Furnace Level 2", bg='black', fg='white', command=addBFurnace2)
                bFurnace2.place(x=560, y=300)
            circuitMakerPhoto = PhotoImage(file="circuitmaker.png")
            circuitMakerImage = Label(root, borderwidth="0", image=circuitMakerPhoto)
            circuitMakerImage.image = circuitMakerPhoto
            circuitMakerImage.place(x=295, y=146)
            circuitMaker.place_forget()
            advCircuitMaker = Button(root, text="Add Adv. Circuit Maker", bg='black', fg='white', command=addAdvCircuitMaker)
            advCircuitMaker.place(x=560, y=270)
        def addGearMaker():
            def addIronPlateMaker():
                ironPlateMakerPhoto = PhotoImage(file="ironplatemaker.png")
                ironPlateMakerImage = Label(root, borderwidth="0", image=ironPlateMakerPhoto)
                ironPlateMakerImage.image = ironPlateMakerPhoto
                ironPlateMakerImage.place(x=359, y=3)
                ironPlateMaker.place_forget()
            gearMakerPhoto = PhotoImage(file="gearmaker.png")
            gearMakerImage = Label(root, borderwidth="0", image=gearMakerPhoto)
            gearMakerImage.image = gearMakerPhoto
            gearMakerImage.place(x=338, y=1)
            gearMaker.place_forget()
            ironPlateMaker = Button(root, text="Add Iron Plate Maker", bg='black', fg='white', command=addIronPlateMaker)
            ironPlateMaker.place(x=500, y=270)
        ...
        gearMaker = Button(root, text="Add Gear Maker", bg='black', fg='white', command=addGearMaker)
        gearMaker.place(x=258, y=195)
        circuitMaker = Button(root, text="Add Circuit Maker", bg='black', fg='white', command=addCircuitMaker)
        circuitMaker.place(x=370, y=195)
    def addFuranceTwo():
        def addFurnaceThree():
            def addFurnaceFour():
                def addFurnaceFive():
                    furnaceLevel5 = PhotoImage(file="furnace5.png")
                    furnaceLvl5Label = Label(root, borderwidth="0", image=furnaceLevel5)
                    furnaceLvl5Label.image = furnaceLevel5
                    furnaceLvl5Label.place(x=193, y=98)
                    furnace5.place_forget()
                furnaceLevel4 = PhotoImage(file="furnace4.png")
                furnaceLvl4Label = Label(root, borderwidth="0", image=furnaceLevel4)
                furnaceLvl4Label.image = furnaceLevel4
                furnaceLvl4Label.place(x=193, y=98)
                furnace4.place_forget()
                furnace5 = Button(root, text="Add furnace level 4", bg='black', fg='white', command=addFurnaceFive)
                furnace5.place(x=450, y=244)
            furnaceLevel3 = PhotoImage(file="furnace3.png")
            furnaceLvl3Label = Label(root, borderwidth="0", image=furnaceLevel3)
            furnaceLvl3Label.image = furnaceLevel3
            furnaceLvl3Label.place(x=193, y=98)
            furnace3.place_forget()
            furnace4 = Button(root, text="Add furnace level 4", bg='black', fg='white', command=addFurnaceFour)
            furnace4.place(x=450, y=244)
        def addCopperOne():
            def addCopperTwo():
                def addCopperThree():
                    def addCopperFour():
        ...
        furnace3 = Button(root, text="Add furnace level 3", bg='black', fg='white', command=addFurnaceThree)
        furnace3.place(x=450, y=244)
    def addCoalTwo():
        def addCoalThree():
            def addCoalFour():
                def addCoalFive():
    ...
    steelPlateMaker = Button(root, text="Add Steel Plate Maker", bg='black', fg='white', command=addSteelPlateMaker)
    steelPlateMaker.place(x=258, y=300)
